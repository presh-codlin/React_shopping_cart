          ...
          <li key={item._id} className="list-none">
            <div className="w-[100%] p-5 rounded-[8px] shadow-[0px_0px_10px_rgba(0,0,0,0.2)] bg-white-150 overflow-hidden border-[1.5px] border-orange-300">
              ...
              <div className="w-[100%] h-[45px] flex justify-between items-center">
                ...
                <button onClick={() => onAddToCart(item)} className="text-[14px] laptop:text-xl text-white-50 rounded-[5px] px-[25px] py-[10px] bg-orange-300 hover:text-orange-300 hover:bg-white-50 hover:border-[1.5px] hover:border-orange-300">Add to Cart</button>
              </div>
            </div>
          </li>
        )
