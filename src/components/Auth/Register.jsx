      ...
      <Fade right cascade>
        <ul className="w-[100%] flex flex-col items-center gap-3">
          <li className="list-none w-[100%]">
            <label className="text-xl text-blue-500 font-medium">Last Name:</label>
          ...
          <li className="list-none w-[100%]">
            <label className="text-xl text-blue-500 font-medium pl-[3px]">Confirm Password:</label>
          ...
          <li className="list-none w-[100%] pt-2">
            <button type="submit" className="text-xl laptop:text-xl text-white-50 w-[100%] rounded-[5px] px-[15px] py-[5px] bg-blue-500 hover:text-orange-300 hover:bg-white-50 hover:border-[1.5px] hover:border-orange-300">Register</button>
          </li>
          <p className="text-xl text-center text-orange-300">Already have an Account? <button onClick={()=> setActiveAuth("login")} className="bg-none border-none outline-none underline">Login</button></p>
        </ul>
      </Fade>
    </form>
  )
