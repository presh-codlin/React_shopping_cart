    ...
    <form onSubmit={createOrder} className="w-[90%]">
      ...
      <Fade right cascade>
        <ul className="w-[100%] flex flex-col items-center gap-3">
          ...
          <p className="text-[16px] laptop:text-xl text-center text-orange-300">Don't have an Account? <button onClick={()=>setActiveAuth("register")} className="bg-none border-none outline-none underline">Register</button></p>
        </ul>
      </Fade>
    </form>
  )
